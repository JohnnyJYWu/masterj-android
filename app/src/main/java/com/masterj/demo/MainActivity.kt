...
class MainActivity : BaseViewActivity<ActivityMainBinding>(), IUnityPlayerLifecycleEvents {

    private lateinit var mUnityPlayer: UnityPlayer // don't change the name of this variable; referenced from native code
    ...
    override fun onResume() {
        super.onResume()
        if (MultiWindowSupport.getAllowResizableWindow(this) && !MultiWindowSupport.isMultiWindowModeChangedToTrue(this)) return
        mUnityPlayer.resume()
    }
